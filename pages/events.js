            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col  space-y-1">
                  ...
                  <h1 className="text-xl">Members -  {e.members ? e.members.length : 0}</h1>
                </div>
                <div className="flex flex-col space-y-1">
                  <button className="px-12 z-50 cursor-pointer text-xl py-2 rounded-xl bg-[#294D69] text-white justify-center items-center">
                    <Link
                     href={`/events/competetions/${e.title && e.title.replace(/\s/g, "").toLowerCase()}`}
                    >
                      Explore
                    </Link>
                  </button>
        ...
        <div className="flex flex-row py-2 space-x-3 z-50 overflow-x-auto overflow-y-hidden">
          {wdata?.map((e) => {
            return (
              ...
              >
                <div className="flex">
                  <h1 className="text-2xl ">{e.title? e.title: "Untitled"}</h1>
                </div>
                <div className="flex flex-col  space-y-1">
                  <h1 className="text-xl">Date - {formatDate(e.date)}</h1>
                  <h1 className="text-xl">Location - {e.mode}</h1>
                  <h1 className="text-xl">Participants - {e.members ? e.members.length : 0}</h1>
                </div>
                <div className="flex flex-col space-y-1">
                  <button className="px-12 z-50 cursor-pointer text-xl py-2 rounded-xl bg-[#294D69] text-white justify-center items-center">
                    <Link
                      href={`/events/workshops/${e.title && e.title.replace(/\s/g, "").toLowerCase()}`}
                    >
                      Explore
                    </Link>
                  </button>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col space-y-1">
                  <button className="px-12 z-50 cursor-pointer text-xl py-2 rounded-xl bg-[#294D69] text-white justify-center items-center">
                    <Link
                      href={`/events/webinars/${e.title && e.title.replace(/\s/g, "").toLowerCase()}`}
                    >
                      Explore
                    </Link>
                  </button>
